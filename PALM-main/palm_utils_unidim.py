"""
Ce fichier regroupe des fonctions, dont nous avons besoin pour le bon fonctionnement du programme PALM unidim.
"""
...
def estimate_c(irm, us):
    ...
    # resize
    yint = y1  # inutile car ici size(irm) = size(us)
