"""
Ce fichier regroupe des fonctions, dont nous avons besoin pour le bon fonctionnement du programme PALM.
"""
...
from matlab_imresize_master import imresize
...
def estimate_c(irm, us, d=6):
    ...
    yint = imresize.imresize(y1, scalar_scale=d, method='bicubic')
...
def FusionPALM(y1, y2, c, tau1, tau2, tau3, tau4, d, m_iteration=10):
    ...
    I = tqdm(list(range(m_iteration))[::-1])
    for i in I:
